...
/*   Updated: 2026/02/26 13:14:47 by adeimlin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	const uint64_t	p0_swar = ((p0 >> 8) + ((uint64_t) p0 << 32)) & 0x00FF00FF00FF00FF;	// R B A G
	const uint64_t	p1_swar = ((p1 >> 8) + ((uint64_t) p1 << 32)) & 0x00FF00FF00FF00FF;	// R B A G
	uint64_t		result;
